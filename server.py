...
from server_content.variables import default_port, connections, action, msg_time
from server_content.functions import get_message, client_message, send_message
